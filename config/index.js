export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx13997524c62ffa82",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "682b8183aace96294930c99c44d74201",
  ...
  USERS: [
    {
      ...
      id: "oZDeO58lY_ZcxctzEhma06GY5_iE",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "C2kYNZbWXUpYLQevRH2RtwcO3xl91ibUTetDu6OOw8w",
      // 所在省份
      province: "河南",
      // 所在城市
      city: "开封",
  ...
  CALLBACK_TEMPLATE_ID: "C2kYNZbWXUpYLQevRH2RtwcO3xl91ibUTetDu6OOw8w",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "oZDeO5zV16LzudDFg2nA1fmCYEtg",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
